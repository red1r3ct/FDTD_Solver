...
#ifndef HXOUTPUTROUTINETM_H_
#define HXOUTPUTROUTINETM_H_
...
/*
 * Класс выводящий данные о поле Hx в файл.
 * Внимание!! Совершает копирование с GPU на CPU
 */

class HxOutputRoutineTM: public Routine {
public:
	HxOutputRoutineTM(std::string _fileName, GridTM* _grid,
		...
		std::cout << "Hx output to files "<< fileName <<"_*.txt : \n";
