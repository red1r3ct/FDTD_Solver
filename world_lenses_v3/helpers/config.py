...
def generate_config(base_path, size_x, size_y, type, num, lam_px, x_sphere):
    ...
    start_time_small = 10000
    end_time_small = 30000
...
Output: Intensity i_small {i_small_out_first_x} {i_small_out_last_x} {i_small_step} {i_small_out_first_y} {i_small_out_last_y} {i_small_step} {start_time_small} {end_time_small} {step_time} 0
Run: {num}
'''.format(
    type=type,
    size_x=size_x,
    ...
    end_time_small=end_time_small,
    start_time_small=start_time_small
)
