...
if __name__ == "__main__":
    ...
    parser.add_argument("--grain_lam", help="Distance between sphere center and straight part ending in diameters")
    ...
    write(lam_px, n_high, n_low, delta_x_lam, grain_lam, num, sim_type)
