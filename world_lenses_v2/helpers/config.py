...
def generate_config(base_path, size_x, size_y, type, num, lam_px, x_sphere):
    ...
    i_small_out_first_x = x_sphere
    i_small_out_last_x = x_sphere + lam_px * 30
    i_small_step = 1
    i_small_out_first_y = 15 * lam_px
    i_small_out_last_y = size_y - 15 * lam_px
...
Output: Intensity i_big {i_big_out_first_y} {i_big_out_last_y} {i_big_step} {i_big_out_first_x} {i_big_out_last_x} {i_big_step} {start_time} {end_time} {step_time} 0
Run: {num}
'''.format(
    type=type,
    size_x=size_x,
